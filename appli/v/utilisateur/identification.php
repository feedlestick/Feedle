                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="." method="POST">
                                    ...
                                    <input type="hidden" name="a" value="verifIdentification">
                                ...
                                <?php 
                                    echo \MVC\A::link('Utilisateur','creerCompte','Créer un compte'),' - '; 
                                    echo \MVC\A::link('Utilisateur','motDePasseOublie','Mot de passe oublié'); 
                                ?>
